    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        if (method !== 'POST') {
          ...
          if (typeof window !== "undefined" && window !== null ? (ref = window.sessionStorage) != null ? ref.token : void 0 : void 0) {
            client.setRequestHeader('Authorization', 'Bearer ' + window.sessionStorage.token);
          }
          client.send(params);
        }
